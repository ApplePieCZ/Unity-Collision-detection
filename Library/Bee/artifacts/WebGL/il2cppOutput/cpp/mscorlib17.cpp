	...
	for (il2cpp_array_size_t i = 0; i < length; i++)
	{
		...
		if (___methodIsStatic)
		{
			if (il2cpp_codegen_call_method_via_invoker(targetMethod))
			{
				...
				{
					// open
					InvokerActionInvoker1< String_t* >::Invoke(targetMethodPointer, targetMethod, NULL, ___language0);
				}
				else
				{
					// closed
					InvokerActionInvoker2< RuntimeObject*, String_t* >::Invoke(targetMethodPointer, targetMethod, NULL, targetThis, ___language0);
				}
			}
			else
			{
				if (___parameterCount == 1)
				{
					...
					((FunctionPointerType)targetMethodPointer)(___language0, targetMethod);
				}
				else
				{
					// closed
					typedef void (*FunctionPointerType) (void*, String_t*, const RuntimeMethod*);
					((FunctionPointerType)targetMethodPointer)(targetThis, ___language0, targetMethod);
				}
			}
		}
			...
			if (currentDelegate->___method_is_virtual_12)
			{
				if (il2cpp_codegen_method_is_generic_instance(targetMethod))
				{
					if (il2cpp_codegen_method_is_interface_method(targetMethod))
						GenericInterfaceActionInvoker0::Invoke(targetMethod, ___language0);
					else
						GenericVirtualActionInvoker0::Invoke(targetMethod, ___language0);
				}
				else
				{
					if (il2cpp_codegen_method_is_interface_method(targetMethod))
						InterfaceActionInvoker0::Invoke(il2cpp_codegen_method_get_slot(targetMethod), il2cpp_codegen_method_get_declaring_type(targetMethod), ___language0);
					else
						VirtualActionInvoker0::Invoke(il2cpp_codegen_method_get_slot(targetMethod), ___language0);
				}
			}
			else
			{
